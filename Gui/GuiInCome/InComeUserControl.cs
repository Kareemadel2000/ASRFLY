...
public partial class InComeUserControl : UserControl
{
                    ...
                    for (int i = 0; i < IdList.Count; i++)
                    {
                        ...
                        if (result == 1)
                        {
                            ...
                            SystemRecord systemRecord = new SystemRecord
                            {
                                ...
                                Details = "تم حذف عملية قبض ذى الرقم التعريفي" + RowId.ToString(),
    ...
    private DataTable SetDataTableColumns(DataTable table)
    {
        ...
        table.Columns["SupplierName"].ColumnName = "العميل";

        table.Columns["InComeDate"].SetOrdinal(3);
        table.Columns["InComeDate"].ColumnName = "تاريخ الصرف";
